...
import argparse
from data.preprocessing.embedding.t5_embedd import embed_from_fasta
import torch
...
def add_args(parser):
    ...
    parser.add_argument("--fastaref", help="Output path to CRC32C ID mappings.")  # defaults to outfile + '_ref'
...
def main(args):
    ...
    embed_from_fasta(inPath, fastaRef, outPath, cache_dir,
